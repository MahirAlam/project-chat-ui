...
function ChatsHeader() {
  ...
  return (
    <>
      <header className="dark:bg-slate-900 bg-slate-200 right-0 z-50 text-sm h-16 fixed left-0 md:right-[70%] lg:right-[75%] p-2 flex items-center justify-between flex-row">
        <div className="">
        ...
        <div className="flex flex-row space-x-2">
          <div>
            ...
            >
              <BiSearchAlt className="w-6 h-6 text-slate-800 dark:text-slate-400 active:fill-blue-500" />
            </button>
            <div className={`${showSearch ? "block" : "hidden"}`}>
              ...
              <div className="absolute left-2 top-2 right-2">
                <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none z-20 pl-[10px]">
                  <BiSearch className="w-5 h-5 text-slate-800 dark:text-slate-400" />
                </div>
                <input
                  type="text"
                  id="search"
                ...
                <button
                  ...
                  className="absolute right-0 sm:right-3 md:-right-1 lg:right-0 top-2 dark:border-slate-400 border-slate-800 focus-visible:border-blue-600 focus-visible:outline-none focus:border-blue-500 hover:border-blue-500 border-[2.5px] p-1 rounded-full items-center z-20"
                >
                  <MdOutlineClose className="text-slate-800 dark:text-slate-400 h-[18px] active:fill-blue-500 w-[18px]" />
                </button>
              </div>
            </div>
          </div>
          <div>
            ...
            >
              <svg
                className="w-full h-full text-slate-800 dark:text-slate-400"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
